        ...
        <div v-if="activeTab === 'relatorios'">
          ...
          <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="flex space-x-4">
              <button
                class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-semibold transition shadow-md shadow-blue-100"
              >
                Gerar PDF Mensal
              </button>
              <button
                class="border border-gray-200 hover:bg-gray-50 text-gray-700 px-6 py-2.5 rounded-xl font-semibold transition"
              >
